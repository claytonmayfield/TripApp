        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The Benson Hotel", "staff@bensonhotel.com", "503-555-123", "Portland", new DateTime(2024, 1, 7, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 15, 0, 0, 0, DateTimeKind.Unspecified), "Go to Voodoo Doughnuts", "Walk in the rain", "Go to Powell's" }
                });
        }
